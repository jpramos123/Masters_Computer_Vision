...
img = cv.imread('standard_test_images/jetplane.tif')
...
alt_image = cv.erode(alt_image, kernel, iterations=1)
alt_image = cv.dilate(alt_image, kernel, iterations=1)
...
ax1.set_title("Imagem com erosão e dilatação aplicadas (1 Iteração)")
ax1.axis("off")
